...
// code----------------------------------------------------------------------------------
int k;
void perfect(string no, int digits, int &cnt, int rem)
{
    if (!rem && !digits)
    {
        cnt++;
    ...
    if (digits == 1)
    {
        ...
        {
            no.push_back(rem + '0');
            perfect(no, digits - 1, cnt, rem - rem);
            no.pop_back();
        }
        return;
    }
...
void solve()
{
    ...
    for (int digits = 1; digits <= 1000; digits++)
    {
        ...
        {
            perfect(to_string(first), digits, cnt, 10-first);
        }
    }
}
